...
- cоздание и объединение веток;
- cоздание запроса на объединение (pull request);
...
### Помощь
Для получения комментариев к вашему коду, создавайте `Pull request`/~`Pull request Draft`~ (к сожалению Draft-ы доступны только в платной подписке GitHub) для ваших изменений и добавляйте [@digital-academy-devops](https://github.com/digital-academy-devops) в ревьюверы. Если вы уверены в верности выбранных решений, можете применять Pull request без ожидания подтверждения, в дальнейшем они будут отсмотрены и, при необходимости, прокомментированы.
